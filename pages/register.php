            ...
            <div class="col-md-7 py-3 py-sm-5 px-4 px-sm-3">
              ...
              <form action="../actions/registerAction.php" method="POST" >
                  ...
                  <div class="row my-2 ">
                    ...
                    <div class="col-12 col-md-6 mt-2 mt-md-0">
                      <input id="address" name="address" placeholder="House No." class="form-control" required="required" type="text">
                      
                    </div>
                    <div class="col-12 col-md-6 mt-2 mt-md-0">
                      <input id="address1" name="address1" placeholder="Resdentail Address" class="form-control" type="text">
                      
                    </div>
                    <div class="col-12 col-md-6 mt-2 mt-md-0">
                      <input id="address2" name="address2" placeholder="Pin Code" class="form-control"  type="text">
