      ...
      <div class="container py-5">
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
              <img src="..\assets\images\Kashyap.jpg"  class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm team-member-image">
              <h5 class="mb-0">Kashyap Savaliya</h5>
              <span class="small text-uppercase text-muted">Team Leader/Developer</span>
              <ul class="social mb-0 list-inline mt-3">
                <li class="list-inline-item"><a href="mailto:kashyapsavaliya41@gmail.com" class="social-link">
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
              <img src="..\assets\images\Dharmik.jpg" alt=""  class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm team-member-image">
              <h5 class="mb-0">Dharmik Sudani</h5>
              <span class="small text-uppercase text-muted">Developer</span>
              <ul class="social mb-0 list-inline mt-3">
                <li class="list-inline-item"><a href="mailto:dharmiksudani488@gmail.com" class="social-link">
                  <i class="fa-solid fa-envelope"></i></a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
              <img src="..\assets\images\jeet.jpg" alt=""  class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm team-member-image">
              <h5 class="mb-0">Jeet Trapasiya</h5>
              <span class="small text-uppercase text-muted">Developer</span>
              <ul class="social mb-0 list-inline mt-3">
                <li class="list-inline-item"><a href="mailto:jeettrapasiya33@gmail.com" class="social-link">
                  <i class="fa-solid fa-envelope"></i></a></li>
              </ul>
            </div>
          </div>
